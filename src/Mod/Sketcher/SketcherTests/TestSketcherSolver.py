...
class TestSketcherSolver(unittest.TestCase):
    ...
    def testCircleToLineDistance_Reference_Secant(self):
        ...
        # FIXME: the block constraints are required to avoid moving them when the reference is
        # caluclated upon solve. Why does this happen? There is no driving constraint.
        ...
        # one cannot add non-driving constraints. In constrast, addConstraint(list(constraint))
